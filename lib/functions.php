...
function MenuList() {
    ...
    $mod_array = array('Login', 'Pinjamdetail','Matakuliah','Buku');  // Modul yang tidak dimasukkan ke Leftmenu
    ...
    $filteredFiles = array_filter($filenames, function($mod) use ($mod_array) {

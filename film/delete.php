...
?>
    ...
    <h2><strong>Hapus Film</strong> <small>Delete Data</small> </h2>
    </div>
    <hr/>
    <form name="formDelete" method="POST" action="">
        ...
        <?php foreach ($rows as $row): ?>
                            ...
                            <dt class="col-sm-3">Kode Film Ke:</dt><dd class="col-sm-9"><?php echo $row['id']; ?></dd>
                            <input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>" readonly />
            
                            <dt class="col-sm-3">Kode Film:</dt><dd class="col-sm-9"><?php echo $row['kode_film']; ?></dd>
            
                            <dt class="col-sm-3">Judul Film:</dt><dd class="col-sm-9"><?php echo $row['judul_film']; ?></dd>
            
                            <dt class="col-sm-3">Sinopsis:</dt><dd class="col-sm-9"><?php echo $row['sutradara']; ?></dd>

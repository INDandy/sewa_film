...
?>
    ...
    if($msg===true){ 
        ...
        echo '<meta http-equiv="refresh" content="3;url='.base_url().'pinjam/">';
    } elseif($msg===false) {
    ...
    <h2><strong>Hapus Peminjaman</strong> <small>Delete Data</small> </h2>
    </div>
    <hr/>
    <form name="formDelete" method="POST" action="">
        ...
        <?php foreach ($rows as $row): ?>
                            ...
                            <dt class="col-sm-3">Bukti Peminjaman:</dt><dd class="col-sm-9"><?php echo $row['nomor_bukti']; ?></dd>
            
                            <dt class="col-sm-3">Kode Anggota</dt><dd class="col-sm-9"><?php echo $row['nomor_anggota']; ?></dd>
            
                            <dt class="col-sm-3">Tanggal Peminjaman:</dt><dd class="col-sm-9"><?php echo $row['tanggal_pinjam']; ?></dd>
            
                            <dt class="col-sm-3">Tanggal Pengembalian:</dt><dd class="col-sm-9"><?php echo $row['tanggal_kembali']; ?></dd>
